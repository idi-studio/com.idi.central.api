...
{
    public class BatchInStoreCommand : Command
    {
    ...
    public class BatchInStoreCommandHandler : ICommandHandler<BatchInStoreCommand>
    {
        [Injection]
        ...
        public Result Execute(BatchInStoreCommand command)
        {
